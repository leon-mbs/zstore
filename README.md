...
Призначена для автоматизації обліку малого бізнесу як альтернатива платного та/або  російського  ПЗ.   
Може бути  розгорнута  як  онлайн (на  хостингу сайтів)   так  і
оффлайн (на персональному комп'ютері або в локальній мережі). 
Веб інтерфейс дозволяє працювати як з десктопного  браузера  
так і з мобільного.  
...
* інтеграція з Опенкарт, WooCommerce, PromUa 
...
### Встановлення та налаштування   
  ...
  Скопіювати вміст папки www у кореневий каталог сайту.  
  Виконати composer.json для завантаження сторонніх бібліотек (або скачати [готову збірку](https://zippy.com.ua/download/fullzstore.zip) ).
  ...
  В загальних налаштуваннях задати  основні параметри робочого оточення та увімкнути необхідні модулі .  
  ...
  Змінити дефолтний пароль у профілі. Задати персональні налаштування профілю.  
