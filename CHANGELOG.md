...
* Добавлен документ  Договор и журнал договоров.
Для  обновления выполнить update430to431.sql обновить папки  app, templates, templates_ua. Обновить библиотеки  согласно  composer.json
