...
class Options extends \App\Pages\Base
{
    ...
    public function __construct() {
        ...
        $this->business->add(new CheckBox('printqrpay'));
        ...
        $this->business->printqrpay->setChecked($common['printqrpay']);
    ...
    public function saveCommonOnClick($sender) {
     ...
     public function saveBusinessOnClick($sender) {
        ...
        $common['printqrpay'] = $this->business->printqrpay->isChecked() ? 1 : 0;
