...
class PayBayList extends \App\Pages\Base
{
    ...
    public function updateDocs() {
        ...
        $list = \App\Entity\Doc\Document::find(" {$br} customer_id= {$this->_cust->customer_id}  and  state > 3  and  (state = ". Document::STATE_WP  ."  or  payamount >payed)   and meta_name in('Order','Invoice','POSCheck','ReturnIssue','GoodsIssue') ", "document_date desc, document_id desc");
