...
class MFList extends \App\Pages\Base
{
    ...
    public function __construct() {
        ...
        $this->mfdetail->add(new TextInput('editinn'));
        $this->mfdetail->add(new TextInput('editaddress'));
    ...
    public function editOnClick($sender) {
        ...
        $this->mfdetail->editinn->setText($this->_mf->inn);
        $this->mfdetail->editaddress->setText($this->_mf->address);
    ...
    public function saveOnClick($sender) {
        ...
        $this->_mf->inn = $this->mfdetail->editinn->getText();
        $this->_mf->address = $this->mfdetail->editaddress->getText();
