...
class Search extends \App\Pages\Base
{
     ...
     public function onModif($sender){
         ...
         foreach($list as $k=>$v) {
             ...
             if($k=='ConstructionInterval')$t = $t ."<tr><td>Годы выпуска</td><td>{$v}</td></tr>" ;
             if($k=='BodyType')$t = $t ."<tr><td>Кузов</td><td>{$v}</td></tr>" ;
             if($k=='DriveType')$t = $t ."<tr><td>Привод</td><td>{$v}</td></tr>" ;
             if($k=='EngineCode')$t = $t ."<tr><td>Код двигателя</td><td>{$v}</td></tr>" ;
             if($k=='EngineType')$t = $t ."<tr><td>Двигатель</td><td>{$v}</td></tr>" ;
             if($k=='NumberOfCylinders')$t = $t ."<tr><td>Цилиндров</td><td>{$v}</td></tr>" ;
             if($k=='Capacity')$t = $t ."<tr><td>Обьем</td><td>{$v}</td></tr>" ;
             if($k=='Power')$t = $t ."<tr><td>Мощность</td><td>{$v}</td></tr>" ;
             if($k=='BrakeSystem')$t = $t ."<tr><td>Тормоз</td><td>{$v}</td></tr>" ;
             if($k=='FuelType')$t = $t ."<tr><td>Топливо</td><td>{$v}</td></tr>" ;
             if($k=='PlatformType')$t = $t ."<tr><td>Тип</td><td>{$v}</td></tr>" ;
             if($k=='Tonnage')$t = $t ."<tr><td>Тоннаж</td><td>{$v}</td></tr>" ;
