   ...
   /****************/   
    ...
    public function check($docs) {
        ...
        /*
          ...
          2    Видалено
          3    Номер не знайдено
          4    Відправлення у місті ХХХХ. (Статус для межобластных отправлений)
          NEW - 41    Відправлення у місті ХХХХ. (Статус для услуг локал стандарт и локал экспресс - доставка в пределах города)
