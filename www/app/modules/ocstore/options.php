...
class Options extends \App\Pages\Base {
    ...
    public function __construct() {
        ...
        $form->add(new DropDownChoice('shopdefcust', \App\Entity\Customer::getList()));
      ...
      public function checkOnClick($sender) {
       ...
       if(strlen($data->success)>0){
           ...
           foreach($data->orders as $o) {
               $orders[$o->order_id] = unserialize(base64_decode($o->order));
           }            
      ...
      public function saveOnClick($sender) {
          ...
          $apiname= $this->cform->apiname->getText();
          $key= $this->cform->key->getText();
          $customer_id= $this->cform->shopdefcust->getValue();
