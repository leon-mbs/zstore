...
function money2str_ru($money, $options = 0) {
    ...
    $numbers_m = array('', 'одна', 'дві', 'три', 'чотири', "п'ять", 'шість', 'сім',
        'вісім', "дев'ять", 'десять', 'одиннадцять', 'дванадцять', 'тринадцять',
        'чотирнадцять', "п'ятнадцать", 'шістьнадцять', 'сімнадцять', 'вісімнадцять',
        "дев'ятнадцать", 'двадцять', 30 => 'тридцять', 40 => 'сорок', 50 => "п'ятдесят",
