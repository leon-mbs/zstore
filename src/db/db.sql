...
DELIMITER ;;
/*!50003 CREATE  TRIGGER `entrylist_after_ins_tr` AFTER INSERT ON `entrylist`
  FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE  TRIGGER `entrylist_after_del_tr` AFTER DELETE ON `entrylist`
  FOR EACH ROW
BEGIN
